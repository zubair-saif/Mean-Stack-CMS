...
function sendErrorReport(errorMeesage) {

    // const output = `Hi <strong style="color:red;">${user.name}!</strong ><br> Here is Your Reset Password Code <strong>${pin}</strong> Which is only valid for 2 hours `;
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
   ...
   <body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
                                                      ...
                                                      <tr>
                                                         <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                                            ...
                                                            <a href="#" style="mso-line-height-rule: exactly;
                                                               ...
                                                               all on your desktop.">
                                                            <img align="none" alt="Tech Spider." height="50" src="https://2.bp.blogspot.com/-ya_ZLup46U0/WZceNSBL39I/AAAAAAAAFGc/Szjhu87CT1085be8im6Md2jwbt0yRLc4ACK4BGAYYCw/s1600/cooltext254820521162154.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
                                                               text-decoration: none; height: auto; width: 107px; height: 50px; margin: 0px;" width="107" />
                                                            </a>
                                                         </td>
                                                      </tr>
                                                   </tbody>
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                                            ...
                                                            color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
                                                            line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
                                                            padding-bottom: 9px; padding-left: 18px;' valign="top">Error :<strong> ${errorMeesage} </strong>
                                                            <br></br>
                                                         </td>
                                                      </tr>
                                                   </tbody>
                                                         ...
                                                         <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                                            ...
                                                            <div style="text-align: center;">Made with
                                                               ...
                                                               <a href="#" style="mso-line-height-rule: exactly;
                                                                  ...
                                                                  font-weight: normal; text-decoration: none; color:#7F6925;" target="_blank" title="Tech Spider">Tech Spider</a>
                                                            </div>
                                                         </td>
                                                      </tr>
                                                   <tbody></tbody>
    ...
    let transporter = nodemailer.createTransport({
        ...
        auth: {
            user: 'techspider700@gmail.com', // generated ethereal user
            pass: '@techspider@007'  // generated ethereal password
        },
        tls: {
    ...
    let mailOptions = {
        from: '"Error Detected" <techspider700@gmail.com>', // sender address
        to: ['zubairsaif700@gmail.com'], // list of receivers
