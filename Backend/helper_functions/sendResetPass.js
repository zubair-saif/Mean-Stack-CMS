...
function sendResetPassEmail(pin, user) {
   ...
   const output = `Hi <strong style="color:red;">${user.firstName}!</strong ><br> Here is Your Reset Password Code <strong>${pin}</strong> Which is only valid for 2 hours `;
   ...
   //                                                             color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
   //                                                             line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
   //                                                             padding-bottom: 9px; padding-left: 18px;' valign="top">Here is Your Reset Password Code <strong> ${pin} </strong> Which is only valid for 2 hours
   //                                                             <br></br>
   //                                                          </td>
   //                                                       </tr>
   //                                                    </tbody>
   ...
   let mailOptions = {
      from: '"CMS" <techspider700@gmail.com>', // sender address
